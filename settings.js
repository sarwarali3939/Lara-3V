...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "rVpTnAIQ#rgBq3ZcCmpRhr-GBD2HEDDEPlBoVnTY0wgBRWyI5B7Y", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "private",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "923188211549",
DEV: process.env.DEV || "923188211549",
